...
function SubmitCode() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('https://tuf-server-113b.onrender.com/api/v1/code/createcode', formData); // Send form data to backend
    ...
    return (
        <>
            <ToastContainer />
            <div className="flex-col md:flex-row flex justify-center items-center h-[1000px] bg-gray-900 text-white">
